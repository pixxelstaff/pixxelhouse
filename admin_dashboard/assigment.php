...
<head>
    ...
    <title>Admin Dashboard - (Assignment)</title>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body p-4">
                                                <div class="row text-center">
                                                    ...
                                                    ?>
                                                        <div class="col-md-4">
                                                            <a href="mark_assigment.php?batch_id=<?php echo $row['batch_id']; ?>">
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        <img src="../batch_image/<?php echo $course_image ?>" width="150px">
                                                                        <button class="btn btn-primary mt-3 form-control"><?php echo $row['batch_name']; ?></button>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                        </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body p-4">
                                                <div class="row text-center">
                                                    ...
                                                    ?>
                                                        <div class="col-md-4">
                                                            <a href="add_assignment.php?batch_id=<?php echo $row['batch_id']; ?>">
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        <img src="../batch_image/<?php echo $course_image ?>" width="150px">
                                                                        <button class="btn btn-primary mt-3 form-control"><?php echo $row['batch_name']; ?></button>
                        ...
                        <div class="row mt-4 mb-3">
                            <div class="col-md-4">
                                ...
                                <select id="sortOrder" class="form-select">
                                    ...
                                    <?php
                                    $show_batch_name_for_select = get_table_data('batch', $con);
