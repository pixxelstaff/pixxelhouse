    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card bg-primary card-bottom-ph my-border-primary-1 my-border-top-1">
          <div class="card-body">
            <h3 class=" text-center text-light">Select Students</h3>
          </div>
        </div>
          ...
          success: function(data) {
            ...
            $.each(data, function(index, item) {
              ...
              <td class='vertical-align-middle'>
               <a href="change_student_batch2.php?student_sno=${item.sno}"><button class="btn btn-primary" style="margin-right:5px">Change Batch</button></a>
              </td>
              <td class='vertical-align-middle'><label style="width:100px;white-space:break-spaces">${item.student_name}</label></td>
              <td class='vertical-align-middle'><label style="width:100px;white-space:break-spaces">${item.father_name}</label></td>
              <td class='vertical-align-middle'><label style="width:100px;white-space:break-spaces">${item.student_contact}</label></td>
              <td class='vertical-align-middle'><label style="width:70px;white-space:break-spaces">${item.batch_name}</label></td>
              <td class='vertical-align-middle'><label style="width:30px;white-space:break-spaces">${item.batch_codes}</label></td>
              <td class='vertical-align-middle'><label>${item.portal_email}</label></td>
