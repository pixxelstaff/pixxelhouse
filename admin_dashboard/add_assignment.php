                                ...
                                <div class="card card-shadow-ph">
                                    <div class="card-body">
                                        ...
                                        if (isset($_POST['btn_sub'])) {
                                            ...
                                            $assignment_name_capital = ucfirst($assignment_name);
                                            $description = $_POST['description'];
                                            $update = "UPDATE `attandance` SET `assigments`='$assignment_name_capital',`assigment_detail`='$description' WHERE `attendance_id`='$assignment_sno'";
