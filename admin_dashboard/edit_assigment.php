                ...
                <div class="card my-border-primary-1 my-border-bottom-1">
                    <div class="card-body table-body">
                        ...
                        if (isset($_POST['btn_submit'])) {
                            ...
                            $update_query = "UPDATE `attandance` SET `student_ids`='$student_ids_combined',`assigments_done`='$assignment_status_combined' WHERE `attendance_date`='$attendance_date'";
                            $insert_result = mysqli_query($con, $update_query);

                            if ($insert_result) {
                        ?>
                                <script>
                                    window.location = "alert.php?icon=<?php echo 'success' ?>&message=<?php echo 'Attendance Updated Successfully!' ?>&location=<?php echo 'edit_assigment.php?batch_id=' . $get_batch_id; ?>";
                                </script>
                        <?php
                            }
                        }
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#datepicker").change(function() {
                ...
                console.log({<?php echo $get_batch_id; ?>,selectedDate})
            });
