                ...
                <div class="card my-border-primary-1 my-border-bottom-1">
                    <div class="card-body table-body">
                        ...
                        if (isset($_POST['btn_submit'])) {
                            ...
                            $update_query = "UPDATE `attandance` SET `student_ids`='$student_ids_combined',`attendance_status`='$attendance_statuses_combined' WHERE `attendance_date`='$attendance_date' AND `batch_name`='$get_batch_id' AND `attendance_teacher_id`='$teacher_sno'";
