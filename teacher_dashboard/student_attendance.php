...
<body>
                ...
                <div class="card my-border-primary-1 my-border-bottom-1">
                    <div class="card-body table-body">
                            ...
                            <div class="col-md-4">
                                <div class="card card-shadow-ph">
                                    ...
                                    <div class="card-body text-center">
                                        <img src="../images/<?php echo $student_image ?>" alt="" class="img img-fluid" width="243px" height="243px">
                                    </div>
                                </div>
                            </div>
                            <!-- col-md-4 -->
                        ...
                        <div class="row mt-3 mb-3">
                            ...
                            <?php
                            $batch_ids = explode(',', mysqli_fetch_assoc(get_table_data2('students', $con, 'sno', $get_student_sno))['batch']);
    ...
    <script src="../assets/pie_chart/javasctipt.js"></script>
